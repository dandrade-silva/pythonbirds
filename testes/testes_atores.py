...
class AtorTestes(TestCase):
    ...
    def assert_nao_colisao(self, ator, ator2):
        ...
        self.assertEqual(status_inicial_ator, ator.status,
                         'Status de ator não deveria mudar')
        self.assertEqual(status_inicial_ator_2, ator2.status,
...
class PassaroAmareloTests(PassaroBaseTests):
    ...
    def test_lancamento_45_graus(self):
        passaro_amarelo = PassaroAmarelo(1, 1)
        # passaro lancado a 45 graus no tempo 2 segundos
        passaro_amarelo.lancar(45, 2)
        ...
        self.assert_passaro_posicao(
            7, 7, ATIVO, passaro_amarelo, 2.2800000000000002)
        ...
        self.assert_passaro_posicao(
            11, 10, ATIVO, passaro_amarelo, 2.4699999999999998)
        ...
        self.assert_passaro_posicao(
            12, 11, ATIVO, passaro_amarelo, 2.5300000000000002)
        ...
        self.assert_passaro_posicao(
            16, 14, ATIVO, passaro_amarelo, 2.7199999999999998)
        ...
        self.assert_passaro_posicao(
            18, 15, ATIVO, passaro_amarelo, 2.7800000000000002)
        ...
        self.assert_passaro_posicao(
            22, 17, ATIVO, passaro_amarelo, 2.9699999999999998)
        ...
        self.assert_passaro_posicao(
            23, 18, ATIVO, passaro_amarelo, 3.0300000000000002)
        ...
        self.assert_passaro_posicao(
            24, 18, ATIVO, passaro_amarelo, 3.0700000000000003)
        ...
        self.assert_passaro_posicao(
            26, 19, ATIVO, passaro_amarelo, 3.1799999999999997)
        ...
        self.assert_passaro_posicao(
            27, 19, ATIVO, passaro_amarelo, 3.2199999999999998)
        ...
        self.assert_passaro_posicao(
            28, 20, ATIVO, passaro_amarelo, 3.2800000000000002)
        ...
        self.assert_passaro_posicao(
            29, 20, ATIVO, passaro_amarelo, 3.3200000000000003)
        ...
        self.assert_passaro_posicao(
            31, 21, ATIVO, passaro_amarelo, 3.4299999999999997)
        ...
        self.assert_passaro_posicao(
            32, 21, ATIVO, passaro_amarelo, 3.4699999999999998)
        ...
        self.assert_passaro_posicao(
            33, 22, ATIVO, passaro_amarelo, 3.5300000000000002)
        ...
        self.assert_passaro_posicao(
            34, 22, ATIVO, passaro_amarelo, 3.5700000000000003)
        ...
        self.assert_passaro_posicao(
            37, 23, ATIVO, passaro_amarelo, 3.6799999999999997)
        ...
        self.assert_passaro_posicao(
            37, 23, ATIVO, passaro_amarelo, 3.7199999999999998)
        ...
        self.assert_passaro_posicao(
            39, 23, ATIVO, passaro_amarelo, 3.7800000000000002)
        ...
        self.assert_passaro_posicao(
            40, 23, ATIVO, passaro_amarelo, 3.8200000000000003)
        ...
        self.assert_passaro_posicao(
            42, 23, ATIVO, passaro_amarelo, 3.9299999999999997)
        ...
        self.assert_passaro_posicao(
            43, 23, ATIVO, passaro_amarelo, 3.9699999999999998)
